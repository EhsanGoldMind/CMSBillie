    ...
    <div class="container">
        ...
        <div class="navbar-left">
            ...
            <a class="navbar-brand" href="{{route('post.index')}}">
                <img class="logo-lighrc=" src="{{asset('/storage/logoimage/billie.png')}}" alt="logo" height="150px"
                     width="150px">
            </a>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                ...
                <h1 style="  font-family: 'Times New Roman', serif;">{{$category->name}}</h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 col-xl-9">
                    <h2>All reasult for <b>{{$category->name}}</b> Category</h2>
                    <hr>
                    <div class="row gap-y">
                            ...
                            @foreach($post as $p)
                                <div class="col-md-6">
                                    <div class="card border hover-shadow-6 mb-6 d-block">
                                        <a href="{{route('post.show',['post'=>$p->id])}}" target="_blank"><img
                                                class="card-img-top" src="{{asset('/storage/postimages/'.$p->image)}}"
                                                alt="Card image cap" style="height:300px"></a>
                                        <div class="p-6 text-center">
                                            <p><a class="small-5 text-lighter text-uppercase ls-2 fw-400"
                                                  href="{{route('post.show',['post'=>$p->id])}}"
                ...
                <div class="col-md-4 col-xl-3">
                    <div class="sidebar px-4 py-md-0">
                        ...
                        <a href="{{route('post.index')}}" class="btn btn-primary">Back</a><br><br>
                        <h6 class="sidebar-title">Category</h6>
                        @foreach($categories as$t)
                            <div class="gap-multiline-items-1">
                                <a class="badge badge-secondary"
                                   href="{{route('categorySection',['category'=>$t->id])}}">{{$t->name}}</a>
                            </div>
                        @endforeach
                        <hr>
    ...
    <div class="container">
        <div class="row gap-y align-items-center">
            ...
            <div class="col-6 col-lg-3 text-right order-lg-last">
                <div class="social">
                    <a class="social-facebook" href="https://www.facebook.com/billieeilish"><i
                            class="fa fa-facebook"></i></a>
                    <a class="social-twitter" href="https://twitter.com/billieeilish"><i class="fa fa-twitter"></i></a>
                    <a class="social-instagram" href="https://www.instagram.com/accounts/login/?next=/billieeilish/"><i
