    ...
    <div class="container">
        ...
        <div class="navbar-left">
            ...
            <a class="navbar-brand" href="{{route('post.index')}}">
                <img class="logo-lighrc=" src="{{asset('/storage/logoimage/billie.png')}}" alt="logo" height="150px" width="150px">
            </a>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                ...
                <h1 style="  font-family: 'Times New Roman', serif;">{{$tag->name}}</h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 col-xl-9">
                    <h2>All reasult for <b>{{$tag->name}}</b> Tag</h2><hr>
                    <div class="row gap-y">
