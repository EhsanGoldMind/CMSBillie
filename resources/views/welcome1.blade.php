...
<head>
    ...
    <title>Billie Eilish — Fan page</title>
...
<!-- Header -->
<header class="header text-center text-white" style="background-image:url('/storage/logoimage/background.jpg');">
    <div class="container">

        <div class="row">
            <div class="col-md-8 mx-auto">

                <h1 style="  font-family: 'Times New Roman', serif;">BILLIE EILISH</h1>
                <p class="lead-2 opacity-90 mt-6">This is first Billie eilish fan page by Ehsan Raoufi</p>
                    ...
                    <div class="row gap-y">
                        ...
                        <div class="col-md-6">
                            <div class="card border hover-shadow-6 mb-6 d-block">
                                <a href="{{route('post.show',['post'=>$p->id])}}"  target="_blank"><img class="card-img-top" src="{{asset('/storage/postimages/'.$p->image)}}" alt="Card image cap" style="height:300px"></a>
                                <div class="p-6 text-center">
                                    <p><a class="small-5 text-lighter text-uppercase ls-2 fw-400" href="{{route('post.show',['post'=>$p->id])}}" target="_blank">{{$p->description}}
                                         </a></p>
                                    <h5 class="mb-0 text-dark">{!!substr($p->content,0,1000) . '...'!!}</h5>
{{--                                    <h5 class="mb-0 text-dark">{!!$p->content!!}</h5>--}}
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-4 col-xl-3">
                    <div class="sidebar px-4 py-md-0">
                        ...
                        <div class="row link-color-default fs-14 lh-24">
                            <div class="col-6"><a href="{{route('categorySection',['category'=>$cat->id])}}">{{$cat->name}}</a></div>
                        </div>
                        @endforeach
                        <hr>
                        ...
                        <div class="gap-multiline-items-1">
                            <a class="badge badge-secondary" href="{{route('tagSection',['tag'=>$t->id])}}">{{$t->name}}</a>
                        </div>
                        @endforeach
                        <hr>

                        <h6 class="sidebar-title">About</h6>
                        <p class="small-3">This Page is Create By Billie Eilish fan.</p>
